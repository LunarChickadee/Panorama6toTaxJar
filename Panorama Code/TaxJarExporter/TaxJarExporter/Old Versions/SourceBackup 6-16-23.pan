...
if monthvalue(start_date) = 6
    message "this range occurs on the fiscal year previous, the procedure will try to open files that have "+lastFYear+" in the name."
    use_last_year = -1
    call .GetTallyFiles
else
    call .GetTallyFiles
...
loop_counter,TJseeds, TJtrees, TJogs, seeds_tally, trees_tally, ogs_tally, TJexporter
...
loop
    ...
    //+++++++
    ///______
    ///Make sure to set the logic for this for ogs and possibly OGS
    toCountry = "US"
